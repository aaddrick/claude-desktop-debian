...
1. Downloads all six artifacts (amd64 + arm64, each in deb/rpm/AppImage).
...
3. Creates the GitHub Release and attaches the six artifacts.
...
- **Verify the Release page.** Six artifacts attached, sizes look right, release notes rendered.
