...
| Linux tray glyph keyed to color scheme, not panel theme (black icon on dark Cinnamon/KDE panels) | anthropics/claude-code | **drafted** — [`604-tray-panel-theme.md`](604-tray-panel-theme.md); verified first-party on Cinnamon (#604/#800 retest) and KDE (2026-07-13 live DBus IconPixmap probe on Plasma 6.6.4); Windows sibling is open upstream ([anthropics/claude-code#72622](https://github.com/anthropics/claude-code/issues/72622)); downstream interim fix is PR [#800](https://github.com/aaddrick/claude-desktop-debian/pull/800) | [aaddrick/claude-desktop-debian#604](https://github.com/aaddrick/claude-desktop-debian/issues/604) |
| tray icon deaf to color-scheme changes after the first one (nativeTheme "updated" latch) | anthropics/claude-code | **drafted** — [`tray-theme-update-latch.md`](tray-theme-update-latch.md); single-host evidence (Nobara 44 / Plasma 6.6.4 / XWayland, portal SettingChanged signals verified firing); file after the panel-theme report and fill in its cross-link | found 2026-07-13 during the panel-theme verification on this host |
